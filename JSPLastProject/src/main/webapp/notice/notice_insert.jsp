...
<body>
<!-- admin_main.jsp에 기본셋팅이 되어 있기 때문에 table안의 내용만 가져와야한다 -->
<form method="post" action="../admin/notice_insert_ok.do">
             <table class="table">
             
              <tr>
               <th class="texet-center" width=15%>공지</th>
               <td width=85%>
              ...
              <tr>
               ...
               <td width=85%>
                <input type=text name=subject id=subject size=50 class="input-sm" required>
               </td>
              </tr>
