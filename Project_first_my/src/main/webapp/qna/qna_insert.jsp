                ...
                <div class="col-12">
                    <nav aria-label="breadcrumb">
                        <ol class="breadcrumb">
                            ...
                            <li class="breadcrumb-item active" aria-current="page">Q&A Page</li>
                        </ol>
                    </nav>
                </div>
            </div>
            ...
            <form method="post" action="../qna/qna_insert_ok.do" enctype="multipart/form-data">
             <table class="table">
              ...
              <tr>
               ...
               <td width=85%>
                <input type=text name=type id=type size=50 class="form-control-sm" required>
               </td>
              </tr>
               ...
               <td width=85%>
                <input type=text name=type_detail id=type_detail size=50 class="form-control-sm" required>
               </td>
              </tr>
