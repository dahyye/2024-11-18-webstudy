...
public class MusicTypeFind extends HttpServlet {
	...
	protected void doGet(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
		...
		out.println("<a href=MainServlet?mode=3&cno=2 class=\"btn btn-sm btn-danger\">top50</a>");
		out.println("<a href=MainServlet?mode=3&cno=1 class=\"btn btn-sm btn-success\">가요</a>");
		...
		out.println("<a href=MainServlet?mode=3&cno=5 class=\"btn btn-sm btn-warning\">트로트</a>");
		out.println("<a href=MainServlet?mode=3&cno=6 class=\"btn btn-sm btn-success\">jazz</a>");
		out.println("<a href=MainServlet?mode=3&cno=7 class=\"btn btn-sm btn-info\">classic</a>");
		out.println("</div>");
		...
		if(startPage>1)
		{
			out.println("<li><a href=\"MainServlet?mode=3&cno="+cno+"&page="+1+"\">&lt;&lt;</a></li>"); // < 화살표
			out.println("<li><a href=\"MainServlet?mode=3&cno="+cno+"&page="+(startPage-1)+"\">&lt;</a></li>"); // < 화살표
		...
		if(endPage<totalpage)
		{
			out.println("<li><a href=\"MainServlet?mode=3&cno="+cno+"&page="+(endPage+1)+"\">&gt;</a></li>"); // > 화살표
			out.println("<li><a href=\"MainServlet?mode=3&cno="+cno+"&page="+totalpage+"\">&gt;&gt;</a></li>"); // >> 화살표
		}
